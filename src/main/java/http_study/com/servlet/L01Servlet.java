...
//HttpServlet : 톰캣 서버 등록할때 같이 참조된 라이브러리에서 제공, 톰캣이 생성할 동적 리소스의 타입
//1. 사용자(클라이언트) 브라우저에서 url 로 서버주소(ip+포트번호)/l01servlet.do을 호출 =>요청
//2. 요청을 받은 톰캣 서버가 L01Servlet 를 객체로 생성하고 브라우저에 html로 변환해서 응답을 한다.
@WebServlet("/l01servlet.do")
public class L01Servlet extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//HttpServletRequest req 요청 객체
		//HttpServletRequest resp 응답 객체
